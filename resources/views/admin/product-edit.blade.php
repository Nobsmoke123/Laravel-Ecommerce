...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal form-row-seperated" action="{{ route('admin:product-update',['id'=>$product->id]) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field()}}
                        <div class="portlet">
                                            ...
                                            <form action="#" method="POST">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input value="" type="number" class="form-control" name="discounted_price" placeholder="Enter discount %"> 
