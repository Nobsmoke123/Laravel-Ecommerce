								...
								<tbody>
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td class="text-center"> <a href="{{ route('admin:category-edit',['id'=>$category->id]) }}" class="btn btn-info"> <i class="fa fa-edit"></i></a></td>
                                            <td class="text-center"> <a href="{{ route('admin:category-delete',['id'=>$category->id]) }}" class="btn btn-danger"> <i class="fa fa-trash"></i></a> </td>
                                        </tr>
                                    @endforeach
                                </tbody>
							</table>
