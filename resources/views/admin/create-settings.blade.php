    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title"> System Settings
                <small>Add Settings</small>
            </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal form-row-seperated" action="{{ route('admin:save-settings') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-edit"></i> Enter Settings Details
                                </div>                                
                            </div>
                                        ...
                                        <div class="tab-pane active" id="tab_general">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" name="dollar_to_naira" placeholder="Enter Dollar to Naira Conversion">
                                                            @if ($errors->has('dollar_to_naira'))
                                                            <span class="help-block">
                                                                <strong>{{ $errors->first('dollar_to_naira') }}</strong>
                                                            </span>
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" name="euro_to_naira" placeholder="Enter Euro to Naira Conversion">
                                                            @if ($errors->has('euro_to_naira'))
                                                            <span class="help-block">
                                                                <strong>{{ $errors->first('euro_to_naira') }}</strong>
                                                            </span>
                                                        @endif
                                                    </div>
                                                </div>
