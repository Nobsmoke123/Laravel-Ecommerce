    ...
    <section class="padding-bottom-60">
      <div class="container"> 
        ...
        <div class="pay-method check-out"> 
          ...
          <ul class="row check-item">
            <li class="col-xs-6">
              <p><img class="margin-right-20" src="{{ asset('app/images/visa-card.jpg') }} " alt=""> Visa Credit Card</p>
            </li>
        ...
        <!-- Button -->
        <div class="pro-btn"> <a href="{{ route('delivery') }}" class="btn-round btn-light">Back to Delivery</a> <a href="{{ route('checkout') }}" class="btn-round">Proceed to Checkout</a> </div>
      </div>
    </section>
@endsection