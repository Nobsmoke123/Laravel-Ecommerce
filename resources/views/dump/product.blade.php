...
<div id="wrap"> 
  ...
  <header>
    <div class="container">
      <div class="logo"> <a href="index-2.html"><img src="{{asset('app/images/logo-3.png')}}" alt="" ></a> </div>
                  ...
                  <div class="col-xs-5">
                    <article class="slider-item on-nav">
                      <div class="thumb-slider">
                        <ul class="slides">
                          <li data-thumb="{{asset('app/images/item-img-1-1.jpg')}}"> <img src="{{asset('app/images/item-img-1-1.jpg')}}" alt="" > </li>
                          <li data-thumb="{{asset('app/images/item-img-1-2.jpg')}}"> <img src="{{asset('app/images/item-img-1-2.jpg')}}" alt="" > </li>
                          <li data-thumb="{{asset('app/images/item-img-1-3.jpg')}}"> <img src="{{asset('app/images/item-img-1-3.jpg')}}" alt="" > </li>
                        </ul>
                      </div>
                    </article>
                  </div>
