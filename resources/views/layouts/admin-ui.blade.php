...
<html lang="en">
    ...
    <head>
		...
		@if(Route::current()->getname() == "admin:product-create")
			...
			<link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />
		@elseif(Route::current()->getname() == "admin:category-create")
			<link href="{{ asset('assets/datatables/datatables.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />
        
        @elseif(Route::current()->getname() == "admin:create-settings")
			<link href="{{ asset('assets/datatables/datatables.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />

		@elseif(Route::current()->getname() == "admin:product-list")
			<link href="{{ asset('assets/datatables/datatables.min.css') }}" rel="stylesheet" type="text/css" />
			<link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
        @elseif(Route::current()->getname() == "admin:users-list")
			<link href="{{ asset('assets/datatables/datatables.min.css') }}" rel="stylesheet" type="text/css" />
			<link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
        @elseif(Route::current()->getname() == "admin:category-list")
			<link href="{{ asset('assets/datatables/datatables.min.css') }}" rel="stylesheet" type="text/css" />
			<link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
        @elseif(Route::current()->getname() == "admin:settings")
			<link href="{{ asset('assets/datatables/datatables.min.css') }}" rel="stylesheet" type="text/css" />
			<link href="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/bootstrap-toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
		@elseif(Route::current()->getname() == " ")
            <link href="{{ asset('assets/bootstrap-daterangepicker/daterangepicker.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/fullcalendar/fullcalendar.min.css') }}" rel="stylesheet" type="text/css" />
            <link href="{{ asset('assets/jqvmap/jqvmap/jqvmap.css') }}" rel="stylesheet" type="text/css" />
        @endif 

		@if(Route::current()->getname() == "admin:product-create")
			<link href="{{ asset('assets/fancybox/source/jquery.fancybox.css') }}" rel="stylesheet" type="text/css" />
        @elseif(Route::current()->getname() == "admin:category-create")
			<link href="{{ asset('assets/fancybox/source/jquery.fancybox.css') }}" rel="stylesheet" type="text/css" />
        @elseif(Route::current()->getname() == "admin:create-settings")
			<link href="{{ asset('assets/fancybox/source/jquery.fancybox.css') }}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ asset('assets/layout.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('assets/darkblue.min.css') }}" rel="stylesheet" type="text/css" id="style_color" />
        <link href="{{ asset('assets/custom.min.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu page-sidebar-menu-hover-submenu page-sidebar-menu-light page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
						...
						<li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
										<i class="icon-feed"></i>
                                        <span class="title">Recurring profiles</span>
                                    </a>
								</li>
								<li class="nav-item  ">
                                    <a href="#" class="nav-link ">
						...
						<li class="nav-item  ">
                            <a href="{{ route('admin:users-list') }}" class="nav-link nav-toggle">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">Sales Setting</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu">
										<li class="nav-item  ">
											<a href="{{ route('admin:settings') }}" class="nav-link ">
												...
												<span class="title">Show Settings</span>
											</a>
										</li>
										<li class="nav-item  ">
											<a href="{{ route('admin:create-settings') }}" class="nav-link ">
												<i class="fa fa-gavel"></i>
												<span class="title">Create Settings</span>
											</a>
										</li>
									</ul>
								</li>
									...
									<ul class="sub-menu">
										<li class="nav-item  ">
											<a href="#" class="nav-link ">
												...
												<span class="title">List Admins</span>
											</a>
										</li>
										<li class="nav-item  ">
											<a href="#" class="nav-link ">
...
<![endif]-->
        ...
        <script src="{{ asset('assets/js.cookie.min.js') }}" type="text/javascript"></script>
		...
		<!-- BEGIN PAGE LEVEL PLUGINS -->
		@if(Route::current()->getname() == "admin:product-create")
			<script src="{{ asset('assets/datatable.js') }}" type="text/javascript"></script>
			...
			<script src="{{ asset('assets/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/bootstrap-maxlength/bootstrap-maxlength.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/fancybox/source/jquery.fancybox.pack.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/plupload/js/plupload.full.min.js') }}" type="text/javascript"></script>
        @elseif(Route::current()->getname() == "admin:category-create")
			<script src="{{ asset('assets/datatable.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/datatables/datatables.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/datatables/plugins/bootstrap/datatables.bootstrap.js') }}" type="text/javascript"></script>
		...
		@elseif(Route::current()->getname() == "dashboard")
			<script src="{{ asset('assets/moment.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/bootstrap-daterangepicker/daterangepicker.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/fullcalendar/fullcalendar.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/flot/jquery.flot.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/flot/jquery.flot.resize.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/flot/jquery.flot.categories.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/jquery-easypiechart/jquery.easypiechart.min.js') }}" type="text/javascript"></script>
			<script src="{{ asset('assets/jquery.sparkline.min.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('assets/app.min.js') }}" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
		<!-- BEGIN PAGE LEVEL SCRIPTS -->
		@if(Route::current()->getname() == "dashboard")
        	<script src="{{ asset('assets/ecommerce-dashboard.min.js') }}" type="text/javascript"></script>
		@elseif(Route::current()->getname() == "admin:product-create")
			 <script src="{{ asset('assets/ecommerce-products-edit.min.js') }}" type="text/javascript"></script> 
        @elseif(Route::current()->getname() == "admin:category-create")
             <script src="{{ asset('assets/ecommerce-products-edit.min.js') }}" type="text/javascript"></script> 
		...
		@elseif(Route::current()->getname() == "admin:product-list")
             <script src="{{ asset('assets/table-datatables-buttons.min.js') }}" type="text/javascript"></script>
        @elseif(Route::current()->getname() == "admin:users-list")
             <script src="{{ asset('assets/table-datatables-buttons.min.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('assets/layout.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('assets/demo.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('assets/quick-sidebar.min.js') }}" type="text/javascript"></script>
