...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('assets/login.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="copyright"> 2018 © Mobel. Admin. </div>
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script src="{{ asset('assets/jquery-validation/js/additional-methods.min.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('assets/login.min.js') }}" type="text/javascript"></script>
